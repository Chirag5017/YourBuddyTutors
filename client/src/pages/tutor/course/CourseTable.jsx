    ...
    <div className="mt-23 bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <Table>
            <TableCaption className="py-6 text-gray-500 bg-gray-50">
            ...
            <TableHeader>
              <TableRow className="hover:bg-gray-50 border-b border-gray-200">
                ...
                <TableHead className="font-semibold text-gray-700 py-4">Course Title</TableHead>
            ...
            <TableBody>
              {data?.courses?.map((course, index) => (
                <TableRow 
                  key={course._id} 
                  className="hover:bg-blue-50 transition-colors duration-200 border-b border-gray-100 group"
                >
                  ...
                  <TableCell className="text-right py-4">
                    <Button 
                      ...
                      className="hover:bg-blue-100 hover:text-blue-700 rounded-lg px-3 py-2 transition-all duration-200 group-hover:shadow-md"
                    >
        ...
        {(!data?.courses || data.courses.length === 0) && (
          <div className="text-center py-12 bg-white rounded-2xl shadow-lg border border-gray-100 mt-8">
